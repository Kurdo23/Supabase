...
Deno.serve(async (req) => {
    ...
    try {
        ...
        // Insérer l'utilisateur dans la table "User" avec les nouveaux champs
        const { error } = await supabase
            ...
            .insert({
                ...
                xp: userProfil.xp,
                isSoftDelete: false, // par défaut false
                last_sign_in_at: new Date().toISOString() // initialisé à la date de création
            });
